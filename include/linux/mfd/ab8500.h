 ...
 * @iddet: machine-specific micro usb cable detect data.
 */
struct ab8500_platform_data {
	...
	struct sec_battery_platform_data_t *sec_bat;
#endif
	...
	struct ab8505_iddet_platdata *iddet;
};
...
void ab8500_panic_dump_regs(int (*panic_read)(u8, u8, u8 *));
#else
